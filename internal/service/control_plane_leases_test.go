...
func seedSharedNodeAcrossSubscriptions(
	...
	older := subscription.NewSubscription(olderSubID, olderSubName, "https://example.com/"+olderSubID, true, false, false)
	...
	newer := subscription.NewSubscription(newerSubID, newerSubName, "https://example.com/"+newerSubID, true, false, false)
