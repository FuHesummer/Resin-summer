...
func TestNodeEntry_MatchRegexs_EmptyRegex_RequiresEnabledSubscriptionWhenLookupProvided(t *testing.T) {
	...
	lookup := func(subID string, hash Hash) (string, bool, bool, []string, bool) {
		switch subID {
		case "sub-disabled":
			return "SubDisabled", false, false, []string{"node-a"}, true
		case "sub-enabled":
			return "SubEnabled", true, false, []string{"node-b"}, true
		default:
...
func TestNodeEntry_MatchRegexs_Basic(t *testing.T) {
	...
	lookup := func(subID string, hash Hash) (string, bool, bool, []string, bool) {
		if subID == "sub-1" {
			return "MySub", true, false, []string{"us-node", "fast"}, true
		}
		return "", false, false, nil, false
	}
...
func TestNodeEntry_MatchRegexs_AllRegexesMustMatch(t *testing.T) {
	...
	lookup := func(subID string, hash Hash) (string, bool, bool, []string, bool) {
		return "Provider", true, false, []string{"us-fast-1"}, true
	}
...
func TestNodeEntry_MatchRegexs_DisabledSubSkipped(t *testing.T) {
	...
	lookup := func(subID string, hash Hash) (string, bool, bool, []string, bool) {
		return "MySub", false, false, []string{"us-node"}, true // disabled
	}
...
func TestNodeEntry_MatchRegexs_MultiSub(t *testing.T) {
	...
	lookup := func(subID string, hash Hash) (string, bool, bool, []string, bool) {
		switch subID {
		case "sub-1":
			return "Provider-A", true, false, []string{"eu-node"}, true
		case "sub-2":
			return "Provider-B", true, false, []string{"us-node"}, true
		}
		return "", false, false, nil, false
	}
