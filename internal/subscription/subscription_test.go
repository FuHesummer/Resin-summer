...
func TestNewSubscription(t *testing.T) {
	s := NewSubscription("id1", "MySub", "https://example.com", true, false, false)
	if s.ID != "id1" {
...
func TestSubscription_NameThreadSafe(t *testing.T) {
	s := NewSubscription("id1", "original", "url", true, false, false)
	s.SetName("updated")
	if s.Name() != "updated" {
...
func TestSubscription_EphemeralNodeEvictDelayThreadSafe(t *testing.T) {
	s := NewSubscription("id1", "sub", "url", true, true, false)
...
func TestSubscription_SwapManagedNodes(t *testing.T) {
	s := NewSubscription("id1", "sub", "url", true, false, false)
