...
func TestScheduler_UpdateSubscription_Success(t *testing.T) {
	...
	sub := subscription.NewSubscription("s1", "TestSub", "http://example.com", true, false, false)
...
func TestScheduler_UpdateSubscription_DownloadViaHTTPServer(t *testing.T) {
	...
	sub := subscription.NewSubscription("s1", "TestSub", srv.URL+"/sub", true, false, false)
	subMgr.Register(sub)
...
func TestScheduler_UpdateSubscription_LocalSubscription_SuccessWithoutFetcher(t *testing.T) {
	subMgr := NewSubscriptionManager()
	sub := subscription.NewSubscription("s1", "LocalSub", "", true, false, false)
...
func TestScheduler_RenameSubscription(t *testing.T) {
	subMgr := NewSubscriptionManager()
	sub := subscription.NewSubscription("s1", "OldName", "http://example.com", true, false, false)
	subMgr.Register(sub)
...
func TestScheduler_ConcurrentUpdateAndRename(t *testing.T) {
	subMgr := NewSubscriptionManager()
	sub := subscription.NewSubscription("s1", "Name0", "http://example.com", true, false, false)
	subMgr.Register(sub)
...
func TestScheduler_DueCheck(t *testing.T) {
	...
	dueSub := subscription.NewSubscription("s1", "Due", "http://example.com", true, false, false)
	...
	notDueSub := subscription.NewSubscription("s2", "NotDue", "http://example.com", true, false, false)
...
func TestScheduler_Tick_UpdatesDueSubscriptionsInParallel(t *testing.T) {
	...
	due1 := subscription.NewSubscription("s1", "Due1", "http://example.com/due1", true, false, false)
	...
	due2 := subscription.NewSubscription("s2", "Due2", "http://example.com/due2", true, false, false)
	...
	notDue := subscription.NewSubscription("s3", "NotDue", "http://example.com/not-due", true, false, false)
...
func TestScheduler_ForceRefreshAllAsync_ReturnsImmediately(t *testing.T) {
	subMgr := NewSubscriptionManager()
	sub := subscription.NewSubscription("s1", "Async", "http://example.com/async", true, false, false)
	subMgr.Register(sub)
...
func TestScheduler_ForceRefreshAll_UpdatesSubscriptionsInParallel(t *testing.T) {
	subMgr := NewSubscriptionManager()
	sub1 := subscription.NewSubscription("s1", "One", "http://example.com/one", true, false, false)
	sub2 := subscription.NewSubscription("s2", "Two", "http://example.com/two", true, false, false)
...
func TestScheduler_ForceRefreshAll_AfterStopDoesNotFetch(t *testing.T) {
	subMgr := NewSubscriptionManager()
	sub := subscription.NewSubscription("s1", "One", "http://example.com/one", true, false, false)
	subMgr.Register(sub)
...
func TestScheduler_StopCancelsInFlightForceRefreshDownload(t *testing.T) {
	...
	sub := subscription.NewSubscription("s1", "One", srv.URL, true, false, false)
	subMgr.Register(sub)
...
func TestEphemeralCleaner_DisabledEphemeralStillEvicted(t *testing.T) {
	subMgr := NewSubscriptionManager()
	sub := subscription.NewSubscription("s1", "EphSub", "url", false, true, false) // disabled + ephemeral
	...
	pool.AddNodeFromSub(h, raw, nil, "s1")
...
func TestScheduler_SetSubscriptionEnabled_RebuildsPlatformViews(t *testing.T) {
	subMgr := NewSubscriptionManager()
	sub := subscription.NewSubscription("s1", "Provider", "http://example.com", true, false, false)
	subMgr.Register(sub)
