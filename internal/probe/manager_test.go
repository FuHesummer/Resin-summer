...
func TestProbeEgress_Success(t *testing.T) {
	...
	pool.AddNodeFromSub(hash, []byte(`{"type":"egress-ok"}`), nil, "sub1")
...
func TestProbeEgress_Failure(t *testing.T) {
	...
	pool.AddNodeFromSub(hash, []byte(`{"type":"egress-fail"}`), nil, "sub1")
...
func TestProbeEgress_CircuitBreak(t *testing.T) {
	...
	pool.AddNodeFromSub(hash, []byte(`{"type":"egress-circuit"}`), nil, "sub1")
...
func TestProbeLatency_Success(t *testing.T) {
	...
	pool.AddNodeFromSub(hash, []byte(`{"type":"latency-ok"}`), nil, "sub1")
...
func TestProbeLatency_Failure(t *testing.T) {
	...
	pool.AddNodeFromSub(hash, []byte(`{"type":"latency-fail"}`), nil, "sub1")
...
func TestProbeEgress_ZeroLatencyIgnored(t *testing.T) {
	...
	pool.AddNodeFromSub(hash, []byte(`{"type":"egress-zero-latency"}`), nil, "sub1")
...
func TestProbeEgress_WithoutLoc_ClearsStoredRegion(t *testing.T) {
	...
	pool.AddNodeFromSub(hash, []byte(`{"type":"egress-clear-loc"}`), nil, "sub1")
...
func TestProbeLatency_ZeroLatencyIgnored(t *testing.T) {
	...
	pool.AddNodeFromSub(hash, []byte(`{"type":"latency-zero"}`), nil, "sub1")
...
func TestProbeEgress_NilFetcher(t *testing.T) {
	...
	pool.AddNodeFromSub(hash, []byte(`{"type":"nil-fetcher"}`), nil, "sub1")
...
func TestTriggerImmediateEgressProbe_WithFetcher(t *testing.T) {
	...
	pool.AddNodeFromSub(hash, []byte(`{"type":"trigger-egress"}`), nil, "sub1")
...
func TestProbeManager_StopWaitsImmediateProbe(t *testing.T) {
	...
	pool.AddNodeFromSub(hash, []byte(`{"type":"stop-immediate"}`), nil, "sub1")
	entry, ok := pool.GetEntry(hash)
	if !ok {
		t.Fatal("entry not found")
	}
...
func TestProbeLatencySync_ReturnsEWMAFromNormalizedDomain(t *testing.T) {
	...
	pool.AddNodeFromSub(hash, []byte(`{"type":"latency-sync"}`), nil, "sub1")
...
func TestProbeSync_EmitsProbeEvents(t *testing.T) {
	...
	pool.AddNodeFromSub(hash, []byte(`{"type":"probe-sync-events"}`), nil, "sub1")
