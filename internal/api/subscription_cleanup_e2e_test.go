...
func TestAPIContract_SubscriptionCleanupAction_E2E(t *testing.T) {
	...
	cp.Pool.AddNodeFromSub(circuitHash, circuitRaw, nil, subID)
	...
	cp.Pool.AddNodeFromSub(noOutboundErrHash, noOutboundErrRaw, nil, subID)
	...
	cp.Pool.AddNodeFromSub(healthyHash, healthyRaw, nil, subID)
