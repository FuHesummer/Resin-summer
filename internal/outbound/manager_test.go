...
func (b *countingBuilder) Build(_ json.RawMessage, _ json.RawMessage) (adapter.Outbound, error) {
	b.mu.Lock()
	b.count++
	b.mu.Unlock()
...
func (b *failBuilder) Build(_ json.RawMessage, _ json.RawMessage) (adapter.Outbound, error) {
...
func (b *blockingClosableBuilder) Build(_ json.RawMessage, _ json.RawMessage) (adapter.Outbound, error) {
	select {
	case <-b.started:
	default:
		close(b.started)
